...
class MakeModuleResourceCommand extends ResourceMakeCommand
{
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            if (Str::startsWith($relative, 'Http'.DIRECTORY_SEPARATOR.'Resources'.DIRECTORY_SEPARATOR)) {
                $relative = Str::after($relative, 'Http'.DIRECTORY_SEPARATOR.'Resources'.DIRECTORY_SEPARATOR);
            }

            $primary = str_replace('/', DIRECTORY_SEPARATOR, $this->modulePrimaryDirectory($this->moduleName, 'resources', 'Http/Resources'));
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the resource in'],
        ]);
    }
}
