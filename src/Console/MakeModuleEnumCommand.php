...
class MakeModuleEnumCommand extends EnumMakeCommand
{
    use ResolvesModules;
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            if (Str::startsWith($relative, 'Enums'.DIRECTORY_SEPARATOR)) {
                $relative = Str::after($relative, 'Enums'.DIRECTORY_SEPARATOR);
            }

            $primary = str_replace('/', DIRECTORY_SEPARATOR, $this->modulePrimaryDirectory($this->moduleName, 'enums', 'Enums'));
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the enum in'],
        ]);
    }
}
