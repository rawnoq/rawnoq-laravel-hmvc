...
class MakeModuleChannelCommand extends ChannelMakeCommand
{
    use ResolvesModules;
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            if (Str::startsWith($relative, 'Broadcasting'.DIRECTORY_SEPARATOR)) {
                $relative = Str::after($relative, 'Broadcasting'.DIRECTORY_SEPARATOR);
            }

            $primary = str_replace('/', DIRECTORY_SEPARATOR, $this->modulePrimaryDirectory($this->moduleName, 'channels', 'Broadcasting'));
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the channel in'],
        ]);
    }
}
