...
class MakeModuleViewCommand extends ViewMakeCommand
{
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            $resourcesPath = base_path('resources').DIRECTORY_SEPARATOR.'views'.DIRECTORY_SEPARATOR;
            $relative = Str::after($parentPath, $resourcesPath);
            ...
            $primary = str_replace('/', DIRECTORY_SEPARATOR, $this->modulePrimaryDirectory($this->moduleName, 'views', 'Resources/views'));
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the view in'],
        ]);
    }
}
