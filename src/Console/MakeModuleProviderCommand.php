...
class MakeModuleProviderCommand extends ProviderMakeCommand
{
    use ResolvesModules;
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            if (Str::startsWith($relative, 'Providers'.DIRECTORY_SEPARATOR)) {
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the provider in'],
        ]);
    }
}
