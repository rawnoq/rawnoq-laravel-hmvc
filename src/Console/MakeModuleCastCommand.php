...
class MakeModuleCastCommand extends CastMakeCommand
{
    use ResolvesModules;
    ...
    protected function getPath($name)
    {
        if ($this->moduleName) {
            ...
            if (Str::startsWith($relative, 'Casts'.DIRECTORY_SEPARATOR)) {
                $relative = Str::after($relative, 'Casts'.DIRECTORY_SEPARATOR);
            }

            $primary = str_replace('/', DIRECTORY_SEPARATOR, $this->modulePrimaryDirectory($this->moduleName, 'casts', 'Casts'));
    ...
    protected function getOptions()
    {
        return array_merge(parent::getOptions(), [
            ['module', null, InputOption::VALUE_OPTIONAL, 'The module to create the cast in'],
        ]);
    }
}
